...
设K位同学从左到右依次编号为 1,2,...,k 他们的身高分别为 T1,T2,..,TK.若存在i(1<=i<=k)使得
T1<T2<...<Ti-1<Ti 且 Ti>Ti+1>...>Tk 则称这K名同学排成了合唱队形
...
while True:
    try:
        ...
        print(n - max(res))  #减去最长的值，即获得去除人数最少的情况，即为解
    except:
        break